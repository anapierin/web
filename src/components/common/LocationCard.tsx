  ...
  return (
    <div className={`card p-8 ${className}`}>
      <div className="flex items-start space-x-6">
        <div
          className={`w-24 h-24 ${colors[colorScheme]} rounded-3xl flex items-center justify-center text-white flex-shrink-0 shadow-large mt-1`}
        >
          {icon}
        </div>
        <div className="flex-1 space-y-4">
          ...
          {whatsappUrl && (
            <Link
              ...
              className="btn-primary inline-flex items-center justify-center gap-2 max-w-md mt-2"
            >
